...
// using github.com/go-coff/peln/appender to append a fixed set of UKI
// payload sections. It is meant for the phase-3a integration test: produces a
...
func main() {
	...
	res, err := appender.Append(stub, sections)
	must(err)
